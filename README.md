...
Sreeport is currently `0.1.1` and under active development. The CLI/core are the stable foundation; the macOS app is a native shell scaffold that will grow into the primary UI.
